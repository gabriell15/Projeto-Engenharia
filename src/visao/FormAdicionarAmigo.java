 ...
 */
public class FormAdicionarAmigo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADICIONAR AMIGO(a)");
        ...
        setSize(new java.awt.Dimension(652, 523));
    ...
    private void jButtonPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisaActionPerformed
       ...
       // preencherTabela("select *from amigo order by cpf");
        preencherTabela( "select *from amigo where cpf_amigo = '"+jTextFieldPesquisa.getText()+"' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAdicionarAmigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAdicionarAmigo().setVisible(true);
            }
        });
    }
