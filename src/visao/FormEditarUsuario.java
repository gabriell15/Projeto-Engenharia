...
public class FormEditarUsuario extends javax.swing.JFrame {
    ...
    public FormEditarUsuario() {
        ...
        preencherTabela("select *from pessoa_f order by nome_user");
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Digite o seu CPF para permissão de edição/exclusão:");
    ...
    private void jTableUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableUsuarioMouseClicked
        ...
        conex.executaSql("select *from pessoa_f where nome_user = '"+nomeUsuario+"' ");
