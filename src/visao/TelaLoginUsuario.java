...
public class TelaLoginUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldcpf.setBounds(210, 50, 140, 30);
        ...
        jLabelUsuario.setBounds(150, 50, 60, 30);
        ...
        LabelFundoLogin.setBackground(new java.awt.Color(0, 0, 0));
    ...
    private void jButtonAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAcessarActionPerformed
        ...
        try {
            con.executaSql("select *from pessoa_f where cpf= '"+jTextFieldcpf.getText()+"'");
            con.rs.first();
            ...
            if(con.rs.getString("senha").equals(jPasswordFieldSenha.getText())){
                ...
                JOptionPane.showMessageDialog(rootPane, "Senha ou CPF ínvalidos !!");
            }
        } catch (SQLException ex) {
           JOptionPane.showMessageDialog(rootPane, "Senha ou CPF ínvalidos !!"+ex);
        }
